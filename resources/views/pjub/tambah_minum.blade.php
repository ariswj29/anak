...
@section('content')
    ...
    <form action="/pjub/minum/store" method="POST">
		@csrf
    <div class="card-body">
      <div class="row"> 
        ...
        <div class="col-6 mb-3">
            ...
            <input type="number" class="form-control" id="exampleControlInput1" name="jumlah_minum" placeholder="Isi Jumlah Minum!" pattern="[0-9-,]{5}" autofocus required oninvalid="setCustomValidity('Tolong Isi dengan angka untuk jumlah air minum!')" onchange="try{setCustomValidity('')}catch(e){}"/>
        </div>
        <div class="col-6 mb-3">

...
<div class="detail-kas">
    ...
    <div class="row justify-content-between">
        <div class="col-md">
            <a href="/pjub/kas/{{ $siklus_id }}/tambah" class="btn btn-primary ml-2 mr-2 mb-2"><i class="fas fa-plus"></i> Tambah Data Kas</a>
            <a href="/pjub/kas/{{ $siklus_id }}/detail/export_excel" class="btn btn-secondary mb-2" target="_blank"><i class="fas fa-print"></i> Export Excel</a>
        </div>
    </div>   
    ...
    <script type="text/javascript">
        $(function () {
            ...
            $('#datatable').DataTable({
                ...
                serverSide: true,
                paging: false,
                ajax: "/pjub/kas/{{ $siklus_id }}/get_data_kas",
                columns: [
                    ...
                    { data: 'kas_id', name: 'kas_id', render: function (data, type, row, meta) { 
                        return '<button type="button" class="btn btn-primary btn-sm mr-2" data-toggle="modal" data-target="#exampleModal'+row.kas_id+'"><i class="fas fa-eye"></i></button><a class="btn btn-info btn-sm mr-2" href="/pjub/kas/'+row.kas_id+'/edit"><i class="fas fa-edit"></i></a><a class="btn btn-danger btn-sm" href="/pjub/kas/'+row.kas_id+'/'+row.siklus_id+'/delete" onclick="return confirm(`Apakah data ini mau dihapus?`)"><i class="fas fa-trash"></i></a>';
                    }},

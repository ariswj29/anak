                    ...
                    <tbody> 
                        ...
                        <tr>
                            <td class="px-6 py-3 leading-6 text-center whitespace-nowrap">
                                ...
                                <td class="text-center">
                                <a class="btn btn-info btn-sm my-1" href="/pjub/kas/{{ $record->id }}/edit"><i class="fas fa-edit"></i></a>
                                <a class="btn btn-danger btn-sm my-1" href="/pjub/kas/{{ $record->id }}/{{ $record->siklus_id }}/delete" onclick="return confirm('Apakah Anda yakin ingin menghapus data tersebut?');"><i class="fas fa-trash"></i></a>
                                </td>
                            </tr>

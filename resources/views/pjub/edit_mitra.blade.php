...
@section('title', 'Aplikasi Ternak | Edit Data Mitra')
...
@section('content')
    ...
    <form action="/pjub/mitra/{{ $mitras->mitra_id }}/update" method="POST">
		@csrf
    <div class="card-body">
      <div class="row"> 
        ...
        <div class="col-md-6 mb-3">
            <br><button class="btn btn-success mt-2" data-toggle="modal" data-target=".bs-example-modal-sm">Perbarui Data</button>

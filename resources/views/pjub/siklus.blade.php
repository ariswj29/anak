...
@section('content')
    ...
    <div class="row justify-content-between">
        <div class="col-md">
            <a class="btn btn-success mr-2 mb-2" style=" font-family: Source Sans Pro"; href="/pjub/siklus/tambah" data-toggle="tooltip" data-placement="bottom" title="Isi ketika ingin menambah siklus baru"><i class="fas fa-plus"></i> Tambah Data</i></a>
            <a href="/pjub/siklus/export_excel" class="btn btn-secondary mb-2" target="_blank"><i class="fas fa-print"></i> Export Excel</a>
        </div>
    </div>
...
<div class="container">
    ...
    <table class="table table-bordered data-table">
        <thead>
            <tr style="background-color:rgba(255, 204, 0, 0.933)">
                <th>No.</th>
                <!-- <th>Farm</th> -->
                <th>Nama Siklus</th>
                <th>Tanggal Mulai</th>
            ...
            var table = $('.data-table').DataTable({
                ...
                columns: [
                    ...
                    { data: 'siklus_id', name: 'siklus_id', render: function (data, type, row, meta) { 
                        return '<button type="button" class="btn btn-primary btn-sm mr-2" data-toggle="modal" data-target="#exampleModal'+row.siklus_id+'"><i class="fas fa-eye"></i></button><a class="btn btn-info btn-sm mr-2" href="/pjub/siklus/'+row.siklus_id+'/edit"><i class="fas fa-edit"></i></a><a class="btn btn-danger btn-sm" href="/admin/siklus/'+row.siklus_id+'/delete" onclick="return confirm(`Apakah data ini mau dihapus?`)"><i class="fas fa-trash"></i></a>';
                    }},

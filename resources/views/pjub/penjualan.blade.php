...
@section('content')
    ...
    <div class="row justify-content-between">
        <div class="col-md">
            <a class="btn btn-success ml-2 mr-2 mb-2" style=" font-family: Source Sans Pro"; href="/pjub/penjualan/tambah"><i class="fas fa-plus"></i> Tambah Data</i></a>
            <a href="/pjub/penjualan/export_excel" class="btn btn-secondary mb-2" target="_blank"><i class="fas fa-print"></i> Export Excel</a>
        </div>
    </div>

...
@section('content')
    ...
    <div class="row justify-content-between">
        <div class="col-md">
            <a class="btn btn-success mr-2 mb-2" style=" font-family: Source Sans Pro;" href="/pjub/farm/tambah" data-toggle="tooltip" data-placement="bottom" title="Isi ketika ingin menambah farm baru"><i class="fas fa-plus"></i> Tambah Data</i></a>
            <a href="/pjub/farm/export_excel" class="btn btn-secondary mb-2" target="_blank"><i class="fas fa-print"></i> Export Excel</a>
        </div>
    </div>
            ...
            var table = $('.data-table').DataTable({
                ...
                columns: [
                    ...
                    { data: 'farm_id', name: 'farm_id', render: function (data, type, row, meta) { 
                        return '<button type="button" class="btn btn-primary btn-sm mr-2" data-toggle="modal" data-target="#exampleModal'+row.farm_id+'"><i class="fas fa-eye"></i></button><a class="btn btn-info btn-sm mr-2" href="/pjub/farm/'+row.farm_id+'/edit"><i class="fas fa-edit"></i></a><a class="btn btn-danger btn-sm" href="/pjub/farm/'+row.farm_id+'/delete" onclick="return confirm(`Apakah data ini mau dihapus?`)" ><i class="fas fa-trash"></i></a>';
                    }},

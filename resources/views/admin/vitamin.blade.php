            ...
            var table = $('.data-table').DataTable({
                ...
                columns: [
                    ...
                    { data: 'vitamin_id', name: 'vitamin_id', render: function (data, type, row, meta) { 
                        return '<a class="btn btn-info btn-sm mr-2" href="/admin/vitamin/'+row.vitamin_id+'/edit"><i class="fas fa-edit"></i></a><a class="btn btn-danger btn-sm" href="/admin/vitamin/'+row.vitamin_id+'/delete" onclick="return confirm(`Apakah data ini mau dihapus?`)"><i class="fas fa-trash"></i></a>';
                    }},
                ]
            });

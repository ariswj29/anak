...
@section('content')
    ...
    <div class="row justify-content-between">
        <div class="col-md">
            <a class="btn btn-success ml-2 mr-2 mb-2" style=" font-family: Source Sans Pro"; href="/admin/mitra/tambah"><i class="fas fa-plus"></i> Tambah Data</i></a>
...
<div class="container">
    ...
    <script type="text/javascript">
        ...
        //         '<tr>'+
        //             '<td>Tempat Tanggal Lahir:</td>'+
        //             '<td>'+d.tempat_lahir+', '+d.tempat_lahir+'</td>'+
        //         '</tr>'+
        //         '<tr>'+
            ...
            var table = $('.data-table').DataTable({
                ...
                columns: [
                    ...
                    { data: 'mitra_id', name: 'mitra_id', render: function (data, type, row, meta) { 
                        return '<button type="button" class="btn btn-primary btn-sm mr-2" data-toggle="modal" data-target="#exampleModal'+row.mitra_id+'"><i class="fas fa-eye"></i></button><a class="btn btn-info btn-sm mr-2" href="/admin/mitra/'+row.mitra_id+'/edit"><i class="fas fa-edit"></i></a><a class="btn btn-danger btn-sm" href="/admin/mitra/'+row.mitra_id+'/delete" onclick="return confirm(`Apakah data ini mau dihapus?`)"><i class="fas fa-trash"></i></a>';
                    }},

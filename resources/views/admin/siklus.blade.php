...
@section('content')
    ...
    <div class="row justify-content-between">
        <div class="col-md">
            <a class="btn btn-success ml-2 mr-2 mb-2" style=" font-family: Source Sans Pro"; href="/admin/siklus/tambah"><i class="fas fa-plus"></i> Tambah Data</i></a>
            ...
            var table = $('.data-table').DataTable({
                ...
                columns: [
                    ...
                    { data: 'siklus_id', name: 'siklus_id', render: function (data, type, row, meta) { 
                        return '<button type="button" class="btn btn-primary btn-sm mr-2" data-toggle="modal" data-target="#exampleModal'+row.siklus_id+'"><i class="fas fa-eye"></i></button><a class="btn btn-info btn-sm mr-2" href="/admin/siklus/'+row.siklus_id+'/edit"><i class="fas fa-edit"></i></a><a class="btn btn-danger btn-sm" href="/admin/siklus/'+row.siklus_id+'/delete" onclick="return confirm(`Apakah data ini mau dihapus?`)"><i class="fas fa-trash"></i></a>';
                    }},

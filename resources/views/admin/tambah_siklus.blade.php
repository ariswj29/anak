...
@section('content')
    <div class="row ">
        <div class="col offset-md-4">
            <div class="card w-50" style="background-color:#007bff; color:white;">
                <div class="card-body">
                    <center><p class="mb-0"]>Tambah Data Siklus</p></center>
                </div>
            </div>
        </div>
    </div>
    ...
    <form action="/admin/siklus/store" method="POST">
		@csrf
    <div class="card-body">
      <div class="row">  
        <div class="col-6 mb-3">
            ...
            <select name="farm_id" class="form-control" id="exampleControlInput1" required oninvalid="this.setCustomValidity('Data tidak boleh kosong!')" oninput="setCustomValidity('')">
                ...
                @foreach ($farms as $farm)
                    <option value="{{ $farm->farm_id }}"> {{ $farm->nama_farm }} -  {{ $farm->mitra->nama  }}</option>
                @endforeach
            </select>
        </div>
        <div class="col-6 mb-3">
        ...
        <div class="col-6 mb-3">
            ...
            <a href="/admin/siklus" class="btn btn-danger mt-2 ml-2">Kembali</a>
        </div>
     </div>
    </div>
	</form>

...
@section('content')
    ...
    <div class="row justify-content-between">
        <div class="col-md">
            <a class="btn btn-success ml-2 mr-2 mb-2" style=" font-family: Source Sans Pro"; href="/admin/penjualan/tambah"><i class="fas fa-plus"></i> Tambah Data</i></a>
        ...
        <div class="modal-dialog" role="document">
            ...
            <div class="modal-body">
                <table class="table">
                    ...
                    <tr>
                        <td>Nama Siklus</td>
                        <td>{{ $penjualan->siklus->nama_siklus }}</td>
                    </tr>
                    <tr>
                        <td>Tanggal Jual</td>

...
@section('content')
    ...
    <div class="row justify-content-between">
        <div class="col-md">
            <a class="btn btn-success mr-2 mb-2" style=" font-family: Source Sans Pro;" href="/admin/farm/tambah"><i class="fas fa-plus"></i> Tambah Data</i></a>
            ...
            var table = $('.data-table').DataTable({
                ...
                columns: [
                    ...
                    { data: 'farm_id', name: 'farm_id', render: function (data, type, row, meta) { 
                        return '<a class="btn btn-info btn-sm mr-2" href="/admin/farm/'+row.farm_id+'/edit"><i class="fas fa-edit"></i></a><a class="btn btn-danger btn-sm" href="/admin/farm/'+row.farm_id+'/delete" ><i class="fas fa-trash"></i></a>';
                    }},

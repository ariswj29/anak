...
@section('title', 'Aplikasi Ternak | Edit Data Bobot Ayam')
...
@section('content_header')
    <h1 class="m-0 text-dark">Edit Data Bobot Ayam</h1>
@stop
...
@section('content')
    ...
    <form action="/admin/berat/{{ $berats->berat_id }}/update" method="POST">
		@csrf
    <div class="card-body">
      <div class="row">
        ...
        <div class="col-md-6 mb-3">
            <label for="exampleFormControlInput1" class="form-label">Rata-rata Bobot Ayam (g)</label>
        ...
        <div class="col-md-6 mb-3">
            ...
            <a href="/admin/berat" class="btn btn-danger mt-2 ml-2">Kembali</a>
        </div>
      </div>
    </div>
	</form>

...
@section('content')
    ...
    <div class="row justify-content-between">
        <div class="col-md">
            <a class="btn btn-success mr-2 mb-2" style=" font-family: Source Sans Pro"; href="/admin/pjub/tambah"><i class="fas fa-plus"></i> Tambah Data</i></a>
            ...
            var table = $('.data-table').DataTable({
                ...
                columns: [
                    ...
                    { data: 'pjub_id', name: 'pjub_id', render: function (data, type, row, meta) { 
                        return '<a class="btn btn-info btn-sm mr-2" href="/admin/pjub/'+row.pjub_id+'/edit"><i class="fas fa-edit"></i></a><a class="btn btn-danger btn-sm" href="/admin/pjub/'+row.pjub_id+'/delete" ><i class="fas fa-trash"></i></a>';
                    }},

...
<div class="detail-mitra">
    @foreach ($farming as $farm) 
        <a href="/mitra/capex/{{ $farm->farm_id }}/tambah" class="btn btn-primary">Tambah Data Modal</a>
        <p>
                    ...
                    <table class="table">
                        ...
                        <tbody> 
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                <a class="btn btn-info btn-sm my-1" href="/mitra/capex/{{ $record->capex_id }}/edit"><i class="fas fa-edit"></i></a>
                                <a class="btn btn-danger btn-sm my-1" href="/mitra/capex/{{ $record->capex_id }}/{{ $record->farm_id }}/delete" onclick="return confirm('Apakah Anda yakin ingin menghapus data tersebut?');"><i class="fas fa-trash"></i></a>
                                </td>
                            </tr>
                            @endforeach

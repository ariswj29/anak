...
@section('content')
    ...
    <form action="/mitra/kas/store" method="POST">
		@csrf
    <div class="card-body">
      <div class="row"> 
        ...
        <div class="col-md-6 mb-3">
            ...
            <input type="text" class="form-control" id="exampleControlInput1" name="uraian" placeholder="Isi Uraian!" required oninvalid="this.setCustomValidity('Data tidak boleh kosong!')" oninput="setCustomValidity('')">
        </div>

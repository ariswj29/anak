...
@section('content')
    ...
    <div class="row justify-content-between">
        <div class="col-md">
            <a href="/mitra/farm/export_excel" class="btn btn-secondary ml-2 mb-2" target="_blank"><i class="fas fa-print"></i> Export Excel</a>
            ...
            var table = $('.data-table').DataTable({
                ...
                columns: [
                    ...
                    { data: 'farm_id', name: 'farm_id', render: function (data, type, row, meta) { 
                        return '<button type="button" class="btn btn-primary btn-sm mr-2" data-toggle="modal" data-target="#exampleModal'+row.farm_id+'"><i class="fas fa-eye"></i></button><a class="btn btn-info btn-sm mr-2" href="/mitra/farm/'+row.farm_id+'/edit"><i class="fas fa-edit"></i></a>';
                    }},

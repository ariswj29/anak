...
class SiklusExport extends DefaultValueBinder implements WithCustomValueBinder, FromCollection, WithHeadings, WithEvents, ShouldAutoSize
{
    ...
    */
    ...
    {
        return Siklus::select( Siklus::raw('ROW_NUMBER() OVER (ORDER BY siklus.nama_siklus) AS no'), "farm.nama_farm", "nama_siklus", "siklus.tanggal_mulai", "siklus.tanggal_selesai", "jenis_ternak", "jumlah_ternak", "harga_satuan_doc", "supplier")

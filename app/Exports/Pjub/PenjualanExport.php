...
class PenjualanExport extends DefaultValueBinder implements WithCustomValueBinder, FromCollection, WithHeadings, WithEvents, ShouldAutoSize
{
    ...
    */
    ...
    {
        return Penjualan::select( Penjualan::raw('ROW_NUMBER() OVER (ORDER BY penjualan.penjualan_id) AS no'), "siklus.nama_siklus", "penjualan.tanggal", "jumlah", "bobot_jual", "jumlah_nominal", "farm.nama_farm",  "mitra.nama")->Join('siklus', 'siklus.siklus_id', '=', 'penjualan.siklus_id')

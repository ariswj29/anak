...
class PakanExport extends DefaultValueBinder implements WithCustomValueBinder, FromCollection, WithHeadings, WithEvents, ShouldAutoSize
{
    ...
    */
    ...
    {
        return Pakan::select( "siklus.nama_siklus", "pakan.tanggal", "jenis_pakan", "jumlah_pakan", "pakan_digunakan",  "farm.nama_farm",  "mitra.nama")->Join('siklus', 'siklus.siklus_id', '=', 'pakan.siklus_id')

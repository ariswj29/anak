...
class PenjualanExport extends DefaultValueBinder implements WithCustomValueBinder, FromCollection, WithHeadings, WithEvents, ShouldAutoSize
{
    ...
    */
    ...
    {
        return Penjualan::select( Penjualan::raw('ROW_NUMBER() OVER (ORDER BY siklus.nama_siklus) AS no'), "siklus.nama_siklus", "penjualan.tanggal", "jumlah", "bobot_jual", "jumlah_nominal", "farm.nama_farm",  "mitra.nama")

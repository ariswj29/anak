...
class FarmExport extends DefaultValueBinder implements WithCustomValueBinder, FromCollection, WithHeadings, WithEvents, ShouldAutoSize
{
    ...
    */
    ...
    {
        return Farm::select( Farm::raw('ROW_NUMBER() OVER (ORDER BY farm.nama_farm) AS no'), "pjub.nama", "nama_farm", "alamat_farm", "mata_uang", "kapasitas_rak_telur", "kapasitas_kandang_doc", "kapasitas_kandang_grower")

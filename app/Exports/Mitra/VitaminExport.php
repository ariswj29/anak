...
class VitaminExport extends DefaultValueBinder implements WithCustomValueBinder, FromCollection, WithHeadings, WithEvents, ShouldAutoSize
{
    ...
    */
    ...
    {
        return Vitamin::select( Vitamin::raw('ROW_NUMBER() OVER (ORDER BY siklus.nama_siklus) AS no'), "siklus.nama_siklus", "vitamin.tanggal", "jenis_vitamin", "jumlah_vitamin", "farm.nama_farm", "mitra.nama")

...
use App\Models\Opex;
use Auth;
use App\DataTables\Mitra\KasDataTable;
use App\Exports\Mitra\KasExport;
...
{   
    ...
    WHERE
        ...
        return $dataTable->render('mitra/detail_kas',['kases'=>$kases],['siklus_id'=>$siklus_id],['sikluses'=>$sikluses]);
        
        return view('mitra/detail_kas',['siklus_id'=>$siklus_id]);
    ...
    // public function detail(KasDataTable $dataTable)
    // {
    ...
    //     return $dataTable->render('mitra/detail_kas',['kases'=>$kases]);

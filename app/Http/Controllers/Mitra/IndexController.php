...
{   
    ...
    GROUP BY
        ...
        return view('mitra/index')->with('summary', $summary);
    }
    ...
    WHERE
        ...
        return view('mitra/detail')->with('pjub', $pjub)->with('mitras', $mitras)->with('pakan', $pakan)->with('berat', $berat)->with('farms', $farms)->with('siklus', $siklus)->with('kematian', $kematian)->with('recording', $recording)->with('summary', $summary);
    }
    ...
    WHERE
        ...
        return redirect('mitra/'. $siklus_id .'/detail');
    }

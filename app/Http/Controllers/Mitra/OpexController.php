...
{   
    ...
    GROUP BY 
        ...
        return view('mitra/opex')->with('summary', $summary);
    }
    ...
    WHERE
        ...
        return view('mitra/detail_opex')->with('pjub', $pjub)->with('mitras', $mitras)->with('recording', $recording)->with('sikluses', $sikluses);
    }
    ...
    WHERE
        ...
        return view('mitra/tambah_opex')->with('sikluses', $sikluses);
    }

...
{   
    ...
    SELECT ROW_NUMBER
        ( ) OVER ( ORDER BY pjub.pjub_id ASC ),
        mitra.mitra_id,
        siklus.nama_siklus,
        farm.nama_farm,
        farm.farm_id,
    ...
    WHERE
        ...
        return view('admin/tambah_opex')->with('sikluses', $sikluses);
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect('admin/opex/'. $siklus_id .'/detail');
    }
    ...
    public function edit($opex_id)
    {
        ...
        WHERE
            ...
            return view('admin/edit_opex')->with('pjubs', $pjubs)->with('mitras', $mitras)->with('farms', $farms)->with('sikluses', $sikluses)->with('opexs', $opexs);
    }

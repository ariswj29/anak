...
class VitaminDataTable extends DataTable
{
    ...
    public function dataTable($query)
    {
        return datatables()
            ->eloquent($query)
            ->addColumn('action', 'vitamindatatable.action');
    }

    /**
     * Get query source of dataTable.
     *
     * @param \App\Models\VitaminDataTable $model
     * @return \Illuminate\Database\Eloquent\Builder
     */
    public function query(VitaminDataTable $model)
    {
        // return $model->newQuery();
        $data = Vitamin::select('*','farm.nama_farm', 'siklus.nama_siklus', 'mitra.nama')
    ...
    {
        return $this->builder()
                    ->setTableId('vitamindatatable-table')

...
class PenjualanDataTable extends DataTable
{
    ...
    public function query(PenjualanDataTable $model)
    {
        ...
        $data = penjualan::select('penjualan.tanggal', 'penjualan.jumlah', 'penjualan.bobot_jual', 'penjualan.jumlah_nominal', 'farm.nama_farm', 'siklus.nama_siklus', 'mitra.nama')
    ...
    {
        return $this->builder()
                    ->setTableId('penjualandatatable-table')
